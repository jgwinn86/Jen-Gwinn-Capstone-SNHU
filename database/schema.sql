...
CREATE TABLE `bids` (
  ...
  KEY `idx_winningbid` (`WinningBid`),
  KEY `idx_fund` (`Fund`),
  KEY `idx_closedate` (`CloseDate`),
  KEY `idx_articleid` (`ArticleID`),
  KEY `idx_articletitle` (`ArticleTitle`)
) ENGINE=InnoDB AUTO_INCREMENT=11955 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2026-04-05 13:18:23
